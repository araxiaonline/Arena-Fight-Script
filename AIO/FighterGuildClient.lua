...
local bossCategories = {
    ...
    Vanilla = {
        {id = 700837, name = "Bazzalan", image = "Interface\\Buttons\\Bazzalan.blp", description = "A cunning satyr and leader of the Searing Blade cultists in Ragefire Chasm, Bazzalan is a swift and powerful foe who swings fast and hits hard.", difficulty = "Easy", color = {0, 1, 0}},
        {id = 700838, name = "Mutanus the Devourer", image = "Interface\\Buttons\\Mutanus.blp", description = "A monstrous murloc driven to madness by the Nightmare, Mutanus emerges from the depths of the Wailing Caverns with devastating force.", difficulty = "Easy", color = {0, 1, 0}},
        {id = 700839, name = "Princess Theradras", image = "Interface\\Buttons\\Theradras.blp", description = "Princess Theradras, an ancient elemental and the corruptor of Maraudon.", difficulty = "Easy", color = {0, 1, 0}},
        {id = 700840, name = "Kel'Thuzad", image = "Interface\\Buttons\\Kel.blp", description = "The Lich King's most loyal servant, Kel'Thuzad commands the necropolis Naxxramas, unleashing devastating frost and shadow magic to decimate all who challenge his master's reign.", difficulty = "Hard", color = {1, 0, 0}},
        {id = 700841, name = "Patchwerk", image = "Interface\\Buttons\\Patchwerk.blp", description = "The most powerful abomination guarding the construct quarter in Naxxramas, Patchwerk is a towering juggernaut of sewn flesh, whose brute strength and relentless attacks make him a fearsome adversary.", difficulty = "Hard", color = {1, 0, 0}},
        {id = 700842, name = "Viscidus", image = "Interface\\Buttons\\Viscidus.blp", description = "A menacing gelatinous horror in the Temple of Ahn'Qiraj, Viscidus is a towering slime creature that bombards adventurers with lethal poison bolts.", difficulty = "Challenging", color = {1, 1, 0}},
        {id = 700843, name = "Gothik the Harvester", image = "Interface\\Buttons\\Gothik.blp", description = "Gothik the Harvester, master necromancer of Naxxramas.", difficulty = "Challenging", color = {1, 1, 0}},
        {id = 700844, name = "Shazzrah", image = "Interface\\Buttons\\Shazzrah.blp", description = "Shazzrah is a powerful arcane elemental boss in Molten Core.", difficulty = "Hard", color = {1, 0, 0}},
        {id = 700845, name = "Baron Geddon", image = "Interface\\Buttons\\BaronGeddon.blp", description = "Baron Geddon, lieutenant of Ragnaros.", difficulty = "Challenging", color = {1, 1, 0}},
        {id = 700846, name = "Broodlord Lashlayer", image = "Interface\\Buttons\\Broodlord.blp", description = "Broodlord Lashlayer, a black dragon from Blackwing Lair.", difficulty = "Challenging", color = {1, 1, 0}},
        {id = 700847, name = "Majordomo Executus", image = "Interface\\Buttons\\Majordomo.blp", description = "Majordomo Executus, servant of Ragnaros.", difficulty = "Challenging", color = {1, 1, 0}},
    ...
    WOTLK = {
        {id = 700861, name = "Varos Cloudstrider", image = "Interface\\Buttons\\Cloudstrider.blp", description = "Varos Cloudstrider, a storm drake rider in The Oculus.", difficulty = "Challenging", color = {1, 1, 0}},
        {id = 700862, name = "Bronjahm", image = "Interface\\Buttons\\Bronjahm.blp", description = "Bronjahm, the soul-trader who guards the Forge of Souls.", difficulty = "Challenging", color = {1, 1, 0}},
        {id = 700863, name = "Elder Nadox", image = "Interface\\Buttons\\ElderNadox.blp", description = "Elder Nadox, an ancient nerubian lord who guards Ahn'kahet.", difficulty = "Easy", color = {0, 1, 0}},
        {id = 700864, name = "Trollgore", image = "Interface\\Buttons\\Trollgore.blp", description = "Trollgore, a monstrous Drakkari troll in Drak'Tharon Keep.", difficulty = "Challenging", color = {1, 1, 0}},
        {id = 700865, name = "Jedoga Shadowseeker", image = "Interface\\Buttons\\Jedoga.blp", description = "Jedoga Shadowseeker, a Twilight's Hammer cultist in Ahn'kahet.", difficulty = "Challenging", color = {1, 1, 0}},
        {id = 700866, name = "Meathook", image = "Interface\\Buttons\\Meathook.blp", description = "Meathook, a brutal undead monstrosity in the Culling of Stratholme.", difficulty = "Challenging", color = {1, 1, 0}},
        {id = 700867, name = "Hodir", image = "Interface\\Buttons\\Hodir.blp", description = "Hodir, the frost giant guardian in Ulduar, master of ice and snow.", difficulty = "Hard", color = {1, 0, 0}},
        {id = 700868, name = "Freya", image = "Interface\\Buttons\\Freya.blp", description = "Freya, the Keeper of Life and guardian of Ulduar's Conservatory.", difficulty = "Hard", color = {1, 0, 0}},
        {id = 700869, name = "Slad'ran", image = "Interface\\Buttons\\Sladran.blp", description = "Slad'ran, a Drakkari troll in Gundrak who controls venomous serpents.", difficulty = "Easy", color = {0, 1, 0}},
        {id = 700870, name = "Moorabi", image = "Interface\\Buttons\\Moorabi.blp", description = "Moorabi, a Drakkari troll in Gundrak who seeks to transform into a mammoth god.", difficulty = "Easy", color = {0, 1, 0}},
        {id = 700871, name = "Toravon the Ice Watcher", image = "Interface\\Buttons\\Toravon.blp", description = "Toravon the Ice Watcher, a frost giant defending Wintergrasp Fortress.", difficulty = "Hard", color = {1, 0, 0}},
