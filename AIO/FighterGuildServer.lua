...
local bosses = {
    ...
    -- Vanilla Bosses
    {id = 700837, name = "Bazzalan", level = 80, points = 25, difficulty = "Easy"},
    {id = 700838, name = "Mutanus the Devourer", level = 80, points = 25, difficulty = "Easy"},
    {id = 700839, name = "Princess Theradras", level = 80, points = 25, difficulty = "Easy"},
    {id = 700840, name = "Kel'Thuzad", level = 83, points = 250, difficulty = "Hard"},
    {id = 700841, name = "Patchwerk", level = 83, points = 250, difficulty = "Hard"},
    {id = 700842, name = "Viscidus", level = 80, points = 75, difficulty = "Challenging"},
    {id = 700843, name = "Gothik the Harvester", level = 83, points = 75, difficulty = "Challenging"},
    {id = 700844, name = "Shazzrah", level = 80, points = 250, difficulty = "Hard"},
    {id = 700845, name = "Baron Geddon", level = 80, points = 75, difficulty = "Challenging"},
    {id = 700846, name = "Broodlord Lashlayer", level = 80, points = 75, difficulty = "Challenging"},
    {id = 700847, name = "Majordomo Executus", level = 80, points = 75, difficulty = "Challenging"},
    {id = 700848, name = "King Gordok", level = 80, points = 250, difficulty = "Challenging"},

    -- BC Bosses
    {id = 700849, name = "Leotheras the Blind", level = 80, points = 250, difficulty = "Hard"},
    {id = 700850, name = "Selin Fireheart", level = 80, points = 25, difficulty = "Easy"},
    {id = 700851, name = "Omor the Unscarred", level = 80, points = 25, difficulty = "Easy"},
    {id = 700852, name = "Hydromancer Thespia", level = 80, points = 25, difficulty = "Easy"},
    {id = 700853, name = "Warbringer O'mrogg", level = 80, points = 25, difficulty = "Easy"},
    {id = 700854, name = "Grand Warlock Nethekurse", level = 80, points = 75, difficulty = "Challenging"},
    {id = 700855, name = "Warp Splinter", level = 80, points = 75, difficulty = "Challenging"},
    {id = 700856, name = "Hex Lord Malacrass", level = 80, points = 75, difficulty = "Challenging"},
    {id = 700857, name = "High Astromancer Solarian", level = 80, points = 75, difficulty = "Challenging"},
    {id = 700858, name = "Teron Gorefiend", level = 80, points = 250, difficulty = "Hard"},
    {id = 700859, name = "Kaz'rogal", level = 80, points = 250, difficulty = "Hard"},
